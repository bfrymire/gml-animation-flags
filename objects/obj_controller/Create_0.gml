...
// Creating flags
animation_manager.add_flag(new AnimationFlag("attack_1", 0, 4, _spd_default));
animation_manager.add_flag(new AnimationFlag("attack_2", 5, 10, _spd_default));
animation_manager.add_flag(new AnimationFlag("attack_3", 11, 16, _spd_default));
animation_manager.add_flag(new AnimationFlag("corner_climb", 17, 21, _spd_default));
animation_manager.add_flag(new AnimationFlag("corner_grab", 22, 25, _spd_slow));
animation_manager.add_flag(new AnimationFlag("corner_jump", 26, 28, _spd_default));
animation_manager.add_flag(new AnimationFlag("crouch", 29, 32, _spd_slow));
animation_manager.add_flag(new AnimationFlag("die", 33, 39, 0.085));
animation_manager.add_flag(new AnimationFlag("fall", 40, 41, _spd_default));
animation_manager.add_flag(new AnimationFlag("hurt", 42, 44, _spd_default));
animation_manager.add_flag(new AnimationFlag("idle_1", 45, 48, _spd_slow));
animation_manager.add_flag(new AnimationFlag("idle_2", 49, 52, _spd_slow));
animation_manager.add_flag(new AnimationFlag("jump", 53, 56, _spd_default));
animation_manager.add_flag(new AnimationFlag("run", 57, 62, _spd_default));
animation_manager.add_flag(new AnimationFlag("slide", 63, 64, _spd_default));
animation_manager.add_flag(new AnimationFlag("roll", 65, 68, _spd_default));
animation_manager.add_flag(new AnimationFlag("stand", 69, 71, _spd_default));
...
sprite_number = sprite_get_number(animation_manager.sprite);
